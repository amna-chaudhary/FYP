...
| --- | --- |
| `Conversation Router Agent` | `apps/projj/backend/server.js` |
| `RAG Knowledge Agent` | `apps/projj/rag_service.py`, `apps/projj/rag_main.py`, `apps/projj/rag_retrieval.py` |
| `Action Orchestrator Agent` | `apps/Gec_Server_C/backend/app.py`, `apps/Gec_Server_C/backend/agent.py` |
| `MCP Tool Proxy Agent` | `apps/Gec_Server_C/mcp_server.py` |
| `Blockchain Transaction Agent` | `apps/Gec_Server_C/backend/chain_api.py`, `apps/Gec_Server_C/backend/aptos_client.py` |
...
### `apps/projj/backend` (Conversation Router + Auth)
...
### `apps/Gec_Server_C/backend` (Action Orchestrator + Chain API)
...
### `apps/Gec_Server_C/mcp_server.py` (MCP Tool Proxy)
...
### `apps/Gec_Server_C/backend/aptos_client.py` and `chain_api.py`
...
3. Add `.env.example` files for `apps/projj/`, `apps/projj/backend/`, `apps/Gec_Server_C/backend/`, and `apps/Gec_Server_C/`.
